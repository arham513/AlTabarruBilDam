...
export default function EligibilityQ3({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.donutSolid}>
        <TouchableOpacity onPress={() => navigation.navigate('EligibilityQ2')}>
          <Text style={styles.navButton}>{'<'}</Text>
        </TouchableOpacity>
        <TouchableOpacity onPress={() => navigation.navigate('EligibilityQ4')}>
          <Text style={styles.navButton}>{'>'}</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.card}>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('EligibilityQ4')}
        >
